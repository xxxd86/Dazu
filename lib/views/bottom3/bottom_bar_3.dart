...
class BottomBar3 extends StatefulWidget {
  ...
  const BottomBar3({
    ...
    required this.addClick, this.onTabSwitch, this.current,
  }) : super(key: key);
                  ...
                  Expanded(
                    child: TabIcons(
                      ...
                      onSelect: () {
                        ...
                        setAnimation(0);
                        widget.onTabSwitch?.call(PageTag.home);
                  ...
                  Expanded(
                    child: TabIcons(
                      ...
                      onSelect: () {
                        ...
                        setAnimation(1);
                        widget.onTabSwitch?.call(PageTag.find);
                      },
                    ),
                  ),
                  ...
                  Expanded(
                    child: TabIcons(
                      ...
                      onSelect: () {
                        ...
                        setAnimation(2);
                        widget.onTabSwitch?.call(PageTag.shop);
                      },
                    ),
                  ),
                  Expanded(
                    child: TabIcons(
                      ...
                      onSelect: () {
                        ...
                        setAnimation(3);
                        widget.onTabSwitch?.call(PageTag.my);
                      },
                    ),
                  ),
                ],
